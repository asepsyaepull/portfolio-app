...
export default function SocialLinks() {
    return (
        <div className="rounded-3xl bg-white border dark:bg-zinc-900  border-gray-300 dark:border-slate-700 p-8 flex flex-wrap gap-4 justify-center md:justify-start">
