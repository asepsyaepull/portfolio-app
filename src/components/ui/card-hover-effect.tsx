...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border dark:bg-zinc-900  border-gray-300 dark:border-slate-700 group-hover:border-slate-700 relative z-20",
        className
      )}
    >
